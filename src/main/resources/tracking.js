function handleGivenEvent(repository, event) {
    ...
    var HistoricalEventClass = Java.type('de.examples.graal.consent.tracking.domain.HistoricalEvent');
...
function loadHistoryByIdOrCreate(repository, id) {
    ...
    if (null == historyOpt) {
        var historyClass = Java.type('de.examples.graal.consent.tracking.domain.ConsentHistory');
